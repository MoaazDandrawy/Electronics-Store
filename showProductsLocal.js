  ...
  for (let i = 0; i < allProducts.length; i++) {
    productDiv.innerHTML += `
      <div class="image">
        ...
        <div class="discount"> OFF <span class="precentage"> 24% </span> </div>
        <div> <a href="./wish.html" class="wishList"> &#9825; </a> </div>
        </div>
        <img src="./images/${allProducts[i].image}" alt="Air Pods" width="100"/>
